...
export default function TemplatePreview({ onClose, name, image, id, canCreate, templateId }: TemplatePreviewProps) {
            ...
            <Modal onClose={onClose} containerClassName="xl:w-[650px]"
                ...
                footer={(close)=> (
                        <div className="py-4 flex flex-col flex-col-reverse sm:flex-row justify-end gap-3 w-full">
                            ...
                            <Button variant="primary" text={tButton("select")} className="px-8" onClick={handleCreate}/>
                        </div>
                )}
            >
