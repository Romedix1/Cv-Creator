...
import CvPreview from '../../../public/images/hero/cv-template.png'
...
export default function HeroSection() {
    ...
    return (
        <section className="pt-12 px-5 flex flex-col gap-16 items-center lg:flex-row lg:px-24 2xl:px-30">
            ...
            <div>
                <div className="aspect-3/4 relative w-[350px] 2xl:w-[450px]">
                    <div className="absolute w-[400px] 2xl:w-[500px] h-[500px] 2xl:h-[600px] bg-default -left-[25px] rounded-full opacity-25 blur-[100px]"></div>
