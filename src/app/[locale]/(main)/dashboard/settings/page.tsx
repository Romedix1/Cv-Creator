  ...
  return (
    <main className="mt-[52px] flex flex-col justify-center px-8 gap-8 pb-[100px] lg:items-center">
      <div className="border bg-surface w-full rounded-[12px] p-6 lg:w-[700px]">
        <PersonalDataSection uid={userProfile.uid} firstName={userProfile.firstName} lastName={userProfile.lastName} avatarUrl={userProfile.avatarUrl} jobTitle={userProfile.jobTitle} email={userProfile.email} phone={userProfile.phone} initials={userProfile.initials} />
      </div>
