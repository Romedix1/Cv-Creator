...
export default function TimelineModern({ data }: { data: ResumeData }) {
    ...
    const createLine = (isLastElement: boolean) => {
        return (
            <div className="mr-4 mt-2">
                <div className="bg-white w-1 h-1 ring-2 ring-[#2563EB] rounded-full z-20 relative"></div>
                {!isLastElement && <div style={{ height: "calc(100% + 20px)" }} className="bg-[#E5E7EB] w-1"></div>}
            </div>
        )
    }
            ...
            <div className="p-6 bg-[#F3F4F6] w-50 shrink-0 flex flex-col items-center gap-8 min-h-210.5">
                ...
                {showContactSection && (
                    <div className="flex flex-col items-center gap-3">
                        <LeftSectionHeader text={tTemplate("contactHeader")} font={spaceGrotesk.className} />
                ...
                {data.skillsCat.length > 0 &&  (
                    <div className="flex flex-col items-center gap-3 w-full">
                        <LeftSectionHeader text={tTemplate("skillsHeader")} font={spaceGrotesk.className} />
                ...
                {data.languages.length > 0 && (
                    <div className="flex flex-col items-center gap-3 w-full">
                        <LeftSectionHeader text={tTemplate("languagesHeader")} font={spaceGrotesk.className} />
                ...
                {data.customSection.map((section) => (section.layout === "left" && section.type === "list") && (
                    <div key={section.id} className="flex flex-col items-center gap-3 w-full min-w-0">
                        <LeftSectionHeader text={section.title} font={spaceGrotesk.className} className="wrap-break-word" />
            ...
            <div className="p-8 flex-1 min-w-0">
                ...
                <div className="flex flex-col gap-8">
                    ...
                    {data.personalInfo.profile && (
                        <div>
                            <TemplateHeader text={tTemplate("profileHeader")} font={spaceGrotesk.className} />
                    ...
                    {data.experience.length > 0 && (
                        <div>
                            <TemplateHeader text={tTemplate("experienceHeader")} font={spaceGrotesk.className} />
                    ...
                    {data.education.length > 0 && (
                        <div>
                            <TemplateHeader text={tTemplate("educationHeader")} font={spaceGrotesk.className} />
                    ...
                    {data.certificates.length > 0 && (
                        <div>
                            <TemplateHeader text={tTemplate("certificatesHeader")} font={spaceGrotesk.className} />
                    ...
                    {data.interests.length > 0 && (
                        <div>
                            <TemplateHeader text={tTemplate("interestsHeader")} font={spaceGrotesk.className} />
