...
export default function FeaturesSection() {
    ...
    const FEATURES_DATA = [
        <CloudUpload className="w-5.75 xl:w-8 text-default" key="i1" />,
        <FileText className="w-5.75 xl:w-8 text-default" key="i2" />,
        <Type className="w-5.75 xl:w-8 text-default" key="i3" />,
        <LayoutTemplate className="w-5.75 xl:w-8 text-default" key="i4" />
    ]
