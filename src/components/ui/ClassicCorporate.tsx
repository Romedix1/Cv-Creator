    ...
    return (
        <div className={`bg-white flex flex-col gap-8 ${merriweather.className} w-full text-black p-12.5`}>
            ...
            {data.personalInfo.profile && (
                <div>
                    <TemplateHeader text={tTemplate("profileHeader")} />
            ...
            {data.experience.length > 0 && (
                <div>
                    <TemplateHeader text={tTemplate("experienceHeader")} />
            ...
            {data.education.length > 0 && (
                <div>
                    <TemplateHeader text={tTemplate("educationHeader")} />
                    <div className="flex flex-col gap-4">
            ...
            {data.skillsCat.length > 0 &&  (
                <div>
                    <TemplateHeader text={tTemplate("skillsHeader")} />
            ...
            {data.languages.length > 0 && (
                <div>
                    <TemplateHeader text={tTemplate("languagesHeader")} />
            ...
            {data.certificates.length > 0 && (
                <div>
                    <TemplateHeader text={tTemplate("certificatesHeader")} />
                    <div className="flex flex-col gap-4">
            ...
            {data.interests.length > 0 && (
                <div>
                    <TemplateHeader text={tTemplate("interestsHeader")} />
                    <div className="flex flex-col gap-4">
