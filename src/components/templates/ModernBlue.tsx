            ...
            <div className="p-6 bg-[#EFF6FF] w-50 shrink-0 flex flex-col items-center gap-8 min-h-210.5">
                ...
                {showContactSection && (
                    <div className="flex flex-col items-center gap-3">
                        <LeftSectionHeader text={tTemplate("contactHeader")} />
                ...
                {data.skillsCat.length > 0 &&  (
                    <div className="flex flex-col items-center gap-3 w-full">
                        <LeftSectionHeader text={tTemplate("skillsHeader")} />
                ...
                {data.languages.length > 0 && (
                    <div className="flex flex-col items-center gap-3 w-full">
                        <LeftSectionHeader text={tTemplate("languagesHeader")} />
                ...
                {data.customSection.map((section) => (section.layout === "left" && section.type === "list") && (
                    <div key={section.id} className="flex flex-col items-center gap-3 w-full min-w-0">
                        <LeftSectionHeader text={section.title} className="wrap-break-word w-full" />
            ...
            <div className="p-8 flex-1 min-w-0">
                ...
                <div className="flex flex-col gap-8">
                    ...
                    {data.personalInfo.profile && (
                        <div>
                            <SectionHeader text={tTemplate("profileHeader")} />
                    ...
                    {data.experience.length > 0 && (
                        <div>
                            <SectionHeader text={tTemplate("experienceHeader")} />
                    ...
                    {data.education.length > 0 && (
                        <div>
                            <SectionHeader text={tTemplate("educationHeader")} />
                    ...
                    {data.certificates.length > 0 && (
                        <div>
                            <SectionHeader text={tTemplate("certificatesHeader")} />
                    ...
                    {data.interests.length > 0 && (
                        <div>
                            <SectionHeader text={tTemplate("interestsHeader")} />
                    ...
                    {data.customSection.map((section) => (section.layout === "center" && section.type === "text") ? (
                        <div key={section.id}>
                            <SectionHeader text={section.title} className="wrap-break-word" />
