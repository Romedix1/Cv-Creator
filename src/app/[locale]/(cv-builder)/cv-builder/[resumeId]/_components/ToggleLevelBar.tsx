...
export default function ToggleLevelBar({ label, checked, onChange }: ToggleLevelBarProps) {
    return (
        <label className="flex items-center justify-between cursor-pointer px-4 py-2 border rounded-lg bg-surface hover:border-default-hover duration-200">
            <span className="text-sm font-medium text-text-muted select-none">{label}</span>
